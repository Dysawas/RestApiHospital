    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeePatient", x => new { x.EmployeesEmployeeId, x.PatientsPatientId });
                    table.ForeignKey(
                        name: "FK_EmployeePatient_Employees_EmployeesEmployeeId",
                        column: x => x.EmployeesEmployeeId,
                        principalTable: "Employees",
                        principalColumn: "EmployeeId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeePatient_Patients_PatientsPatientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeePatient_PatientsPatientId",
